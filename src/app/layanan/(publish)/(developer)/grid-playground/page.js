  ...
  return (
    <div className="container mx-auto min-h-[84vh]">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-4 mt-5">
        <div className="border rounded-md w-full lg:w-1/4 flex flex-col gap-4 p-4">
          <div>
          ...
          <div className="flex gap-3 flex-wrap">
            <button
              onClick={addItem}
              className="bg-slate-900 flex-grow text-white py-2 px-5 rounded-md flex items-center gap-2"
            >
              <svg
            ...
            <button
              onClick={removeItem}
              className={`bg-red-800 flex-grow text-white py-2 px-5 rounded-md flex items-center gap-2 ${
