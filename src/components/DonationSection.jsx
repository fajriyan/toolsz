...
export default function DonationSection() {
   return (
      <section className="container mx-auto my-[150px] px-5 md:px-0">
         <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-950 to-slate-950 px-6 py-10 shadow-2xl sm:px-8 md:px-10 md:py-12">
            ...
            <div className="relative z-10 grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
               <div className="space-y-4 text-white">
                  <h2 className="max-w-xl text-3xl font-semibold leading-tight sm:text-4xl">
                     Dukung Toolsz supaya terus hidup, berkembang, dan tetap
                     gratis.
                  </h2>
                  <p className="max-w-2xl text-sm leading-6 text-slate-300 sm:text-base">
                     Setiap donasi membantu biaya server, maintenance, dan
                     pengembangan tools baru. Kalau Toolsz pernah membantu
                     pekerjaanmu, kamu bisa balas dukungan lewat salah satu
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                     <Link
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-cyan-100"
                     >
                        Dukung via Saweria
                     </Link>
                     <Link
