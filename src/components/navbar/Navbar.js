          ...
          <div className="">
            <div className="flex flex-col w-full gap-1 px-1 py-2 z-[99]">
              ...
              >
                ...
                <div className="">Convert Case</div>
              </button>
              <button
                onClick={() => LinkMobile({ to: "/layanan/robots-generator" })}
                className={
                  currentRoute === "/layanan/robots-generator"
              ...
              >
                ...
                <div className="">Robots Generator</div>
              </button>
              <button
                onClick={() => LinkMobile({ to: "/layanan/qr-generator" })}
                className={
                  currentRoute === "/layanan/qr-generator"
                    ? "flex items-center gap-2 p-2  bg-slate-50 border rounded-md relative"
                    : "flex items-center gap-2 p-2 hover:bg-slate-50 border border-white rounded-md relative"
                }
              >
                ...
                <div className="">QR Code Generator</div>
              </button>
              <button
                onClick={() => LinkMobile({ to: "/layanan/meta-generator" })}
                className={
                  currentRoute === "/layanan/meta-generator"
                    ? "flex items-center gap-2 p-2  bg-slate-50 border rounded-md relative"
                    : "flex items-center gap-2 p-2 hover:bg-slate-50 border border-white rounded-md relative"
                }
              >
                ...
                <div className="">Meta Generator</div>
              </button>
              <button
                onClick={() => LinkMobile({ to: "/layanan/flex-playground" })}
                className={
                  currentRoute === "/layanan/flex-playground"
                    ? "flex items-center gap-2 p-2  bg-slate-50 border rounded-md relative"
                    : "flex items-center gap-2 p-2 hover:bg-slate-50 border border-white rounded-md relative"
                }
              >
                ...
                <div className="">Flex Playground</div>
              </button>
              <button
                onClick={() => LinkMobile({ to: "/layanan/grid-playground" })}
                className={
                  currentRoute === "/layanan/grid-playground"
                    ? "flex items-center gap-2 p-2  bg-slate-50 border rounded-md relative"
                    : "flex items-center gap-2 p-2 hover:bg-slate-50 border border-white rounded-md relative"
                }
              >
              ...
              <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 translate-y-24 transition-all duration-500  absolute -left-[200px] top-[60px] min-h-[200px] md:w-max bg-white rounded-md border p-2 flex gap-5 font-normal cursor-default z-[99]">
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <Link
                    ...
                    className={
                      currentRoute === "/layanan/remove-whitespace"
                        ? classStyleDesktopActive
                        : classStyleDesktop
                    }
                  >
                    ...
                    <div className="">Remove Whitespace</div>
                  </Link>
                </div>
              </div>
            </span>
