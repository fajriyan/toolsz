...
const Navbar = () => {
  ...
  return (
    <>
      <div className="bg-white text-black border-b sticky top-0">
        <div className="container mx-auto flex items-center h-[60px]">
          ...
          <div className="flex justify-center gap-5 w-[73%]">
            {/* {Menu.map((m) => (
              <div className="" key={Math.random(20)}>
                Menu
                <svg
            ...
            <span className="group py-[17px] relative border-b-2 font-medium border-white hover:border-slate-500 cursor-pointer">
              Produk
              <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 translate-y-24 transition-all duration-500  absolute left-0 top-[60px] h-[200px] w-[500px] bg-white rounded-md border p-2 flex gap-5 font-normal cursor-default">
